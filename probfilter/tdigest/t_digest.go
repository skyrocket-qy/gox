...
// compression: A parameter that controls the accuracy and size of the sketch. Higher values mean more accuracy and larger size.
...
func Merge(ctx context.Context, rdb *redis.Client, destKey string, sourceKeys ...string) error {
	args := []interface{}{"TDIGEST.MERGE", destKey}
...
func Quantile(ctx context.Context, rdb *redis.Client, key string, quantile float64) (float64, error) {
